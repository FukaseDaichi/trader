...
export const GLOSSARY: Record<string, GlossaryEntry> = {
  ...
  take_profit: {
    ...
    formal: "利確ライン",
    short:
      "買った後にここまで上がったら、いったん売って利益を確定させる目安の価格。",
    analogy:
      "「ここまで晴れたら洗濯物を取り込む」と先に決めておく感覚。欲張りすぎを防ぐ。",
  },
  time_exit: {
    term: "手仕舞い期限",
    formal: "時間バリア",
    short:
      "利確にも損切りにも届かないまま、この日数が過ぎたら値動きにかかわらず一度手仕舞う目安。",
    analogy:
      "予約席の時間制限のようなもの。だらだら持ち続けて塩漬けにしないための区切り。",
  },
  drawdown: {
    term: "一時的な落ち込み",
    formal: "ドローダウン",
